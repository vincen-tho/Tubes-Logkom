...
startGame :- 
    ...
    write('               Your goal is to collect 20000 Gold before the year ends           '),nl,
    write('                          In this world, a year is 50 days                       '),nl,
    write('                        1 step is 1 hour, and a day is 24 hours                  '),nl,
